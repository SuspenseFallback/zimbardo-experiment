    ...
    >
      <main className={styles.homePage}>
        <div className={styles.homePage1}>
          ...
          <h2 className={styles.homePage1SubHeader}>
            or Zimbardo et. al. 1971
          </h2>
        </div>
        <div className={styles.homePage2}>
          ...
          <p className={styles.homePage2Description}>
            ...
            those social roles. He also wanted to observe the effects of
            de-individuation on prisoners and guards. He did this by setting up
            an experiment where 20 male college students who signed up from a
            newspaper for $15/hour were assigned to 10 prisoners and 10 guards.
            They were given proper prison treatment, and they had rules in
            place. These rules, however, were broken, causing extreme
            psychological damage to some prisoners and ended after 6 days,
            instead of the planned 14 days. The Stanford Prison Experiment
            created a huge debate on ethics for psychological experiments and
            led to the creation of multiple committees that were in charge of
            regulating experiments to ensure that they were ethical and did not
          ...
          <p className={styles.homePage2Description}>
            ...
            These things caused effects such as:
            <ol>
              <li>Prisoners having depression and anxiety</li>
              <li>Deindividuation</li>
              <li>Prisoners forgetting their names</li>
            </ol>
            and other mild psychological effects.
          </p>
          ...
          <p className={styles.homePage2Description}>
            ...
            be the Stanford Prison Experiment. His experiment raised lots of
            ethical concerns regarding experiments, and caused a lot of debate
            on ethics and the creation of committees which has transformed the
            way that modern psychological ethics works.
          </p>
        </div>
      </main>
    </Layout>
